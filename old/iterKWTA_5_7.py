...
# learning of hh connecitons reduce the both populations for all learning speeds (hh)
# however increasing yy speed could create small h and  increase y (still less than original)
# learning yh not clear
