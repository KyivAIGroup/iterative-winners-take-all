...
# no connections from y

# addition of learning foro inh inh connection has interesting effect. For different learning speeds it is possible that:
# 1) both populations are smaller than original
# 2) both populations are larger
# 3) inh smaller ex larger
# 4) inh larger ex smaller
