...
# it works as expected. new inhibitory connections reduce the number of active excitatory neurons
# input sparsity should be small, otherwise the learning for one patterns interfere with others
